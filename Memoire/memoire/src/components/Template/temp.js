...
export default function Temp() {
        ...
        },
        {
            ...
            renderCell: (params) => (<>
                <IconButton onClick={() => {
                    ...
                    fetch('https://ophtaback.onrender.com/templates/'.concat(params.row._id), urlParams).then(res => res.json().then((resp) => {
                        console.log(resp)
    ...
    useEffect(() => {
        fetch('https://ophtaback.onrender.com/templates').then(res => res.json().then((data) => {
            setTemplates(data)
    ...
    const sauvegarderTemplate = (e) => {
        if (quill) {
            ...
            fetch('https://ophtaback.onrender.com/templates/'.concat(id),urlParams).then(res=>res.json().then((resp)=>{
                console.log(resp)
                window.location.reload(false)
            }))
        }
